...
public class ModPlacedFeatures {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        register(context, HENBANE_PLACED,             configured.getOrThrow(ModConfiguredFeatures.HENBANE),             rarityPatch(10));
        ...
        register(context, HEXED_BULRUSH_PLACED,       configured.getOrThrow(ModConfiguredFeatures.HEXED_BULRUSH),       rarityPatch(10));
        register(context, NIGHTSHADE_BUSH_PLACED,     configured.getOrThrow(ModConfiguredFeatures.NIGHTSHADE_BUSH),     rarityPatch(10));
        register(context, DUCKWEED_PLACED,            configured.getOrThrow(ModConfiguredFeatures.DUCKWEED),            rarityPatch(10));
        register(context, LOTUS_FLOWER_PLACED, configured.getOrThrow(ModConfiguredFeatures.LOTUS_FLOWER), waterSurfacePatch(2));
        ...
        register(context, COTTONWOOD_COCOON_PLACED,
