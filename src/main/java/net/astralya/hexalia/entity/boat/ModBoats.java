...
public class ModBoats {
    ...
    public static final Identifier COTTONWOOD_BOAT_ID = Identifier.of(HexaliaMod.MODID, "cottonwood_boat");
    public static final Identifier COTTONWOOD_CHEST_BOAT_ID = Identifier.of(HexaliaMod.MODID, "cottonwood_chest_boat");

    public static final Identifier WILLOW_BOAT_ID = Identifier.of(HexaliaMod.MODID, "willow_boat");
    public static final Identifier WILLOW_CHEST_BOAT_ID = Identifier.of(HexaliaMod.MODID, "willow_chest_boat");
